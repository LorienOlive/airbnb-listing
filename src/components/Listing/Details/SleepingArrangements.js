      ...
      <div>
        <div className="row details-row">
          <div className="col-md-2 details-header-column">
            <h3 className="details-header">Sleeping arrangements</h3>
          </div>
          <div className="col-md-10 details-content-column">
            <div className="row prices-top-row">
              <div className="col-md-5 sleeping-column">
                ...
                <h3 className="details-header">Bedroom {listing.description.sleeping_arrangements.bedrooms}</h3>
                <p className="details-text">{listing.description.sleeping_arrangements.beds}</p>
              </div>
            </div>
          </div>
        </div>
